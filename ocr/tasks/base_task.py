...
class BaseTask(ABC):
    ...
    def get_model(self, model_name: str) -> Any:
        if model_name in ["gemini-1.5-flash", "gemini-1.5-flash-8b"]:
            return models.Gemini(model_name, GEMINI_API_KEY)

        if model_name in ["gemini-2.0-flash"]:
            return models.Gemini2(model_name, GEMINI_API_KEY)
            ...
            return models.mistral(model_name, MISTRAL_API_KEY)
